...
const SectionTitle = ({ title, text, blob }) => {
  return (
    <section className="relative my-16 text-center">
      {blob && (
        <div className="absolute -left-0 -top-10 z-0 h-[200px] w-[500px] rotate-45 rounded-full bg-blue-blob blur-[100px] filter"></div>
      )}
      ...
      {blob && (
        <div className="absolute -right-0 -top-10 z-0 h-[200px] w-[500px] -rotate-[20deg] rounded-full bg-red-blob blur-[100px] filter"></div>
      )}
    </section>
  );
};
