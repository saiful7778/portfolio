...
const config: Config = {
  ...
  theme: {
  	...
  	extend: {
  		...
  		backgroundImage: {
  			'blue-blob': 'linear-gradient(180deg, rgba(84, 84, 212, 0.25) 0%, rgba(84, 84, 212, 0.15) 100%)',
  			'red-blob': 'linear-gradient(180deg, rgba(251, 168, 28, 0.20) 0%, rgba(224, 86, 136, 0.10) 100%)'
  		},
  		keyframes: {
  			'accordion-down': {
  				from: {
